--[[
  "ForkSignal" is a fork of the FastSignal you can find here (https://devforum.roblox.com/t/fastsignal-1021-a-consistent-signal-library/1360042).
  Nothing really changed, but rather I have only made it use the DeferredSignal behavior only. However, I expect to make small changes over time.
]]
local ScriptSignal = {}
